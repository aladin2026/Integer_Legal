...
public interface IOperationsRepository
{
    ...
    Task AddPartyAsync(Party party, CancellationToken ct);
    Task AddConflictCheckAsync(ConflictCheck check, CancellationToken ct);
    Task AddMatterPartyAsync(MatterParty party, CancellationToken ct);
    Task AddProcedureAsync(Procedure procedure, CancellationToken ct);
    Task AddHearingAsync(Hearing hearing, CancellationToken ct);
    Task AddDocumentAsync(LegalDocument document, CancellationToken ct);
    Task AddDocumentVersionAsync(DocumentVersion version, CancellationToken ct);
    Task AddTimeEntryAsync(TimeEntry entry, CancellationToken ct);
    Task AddExpenseEntryAsync(ExpenseEntry entry, CancellationToken ct);
    Task AddBudgetAsync(Budget budget, CancellationToken ct);
    Task AddPrebillAsync(Prebill prebill, CancellationToken ct);
    Task AddPrebillLineAsync(PrebillLine line, CancellationToken ct);
    Task AddRoleAssignmentAsync(RoleAssignment assignment, CancellationToken ct);
    Task AddScheduledCommandAsync(ScheduledCommand command, CancellationToken ct);
